...
$GLOBAL_PRODUCT_CARDS = [
  ...
  [
    ...
    "long_description" => "Fully integrated machine for Non-Recovery ovens. Features a 20m pusher beam, leveling system, and synchronized roller stamping arrangement.",
