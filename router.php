...
if (preg_match('#^/(header|footer|common-head|page-helpers|global-products|our-products|related-products|sidebar-quote-form|clients|gallery-products|load-secrets|webcounter|router|secrets\.example)(\.php)?$#', $path)) {
