...
- [x] **2026-09-19: Two workshop photos of the single disc coal crusher added.** From the owner's phone (HEIC), converted to JPEG (1800x2400, **GPS and all other metadata removed**) as `coal-crusher-6.jpg` / `coal-crusher-7.jpg` in `assets/img/product-images/coal-crusher-single-disc/`, with WebP and thumbnails from `tools/optimize_images.py`. They appear as the 2nd and 3rd gallery images on the product page and in the photo gallery. The product brochure's photo picks are unchanged.
