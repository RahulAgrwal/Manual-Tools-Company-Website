...
<body>
  ...
  <main id="main">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              ...
              <ul>
                <li><span class="icon"><i class="fas fa-check"></i></span> <strong>Idler with Roller</strong></li>
                <li><span class="icon"><i class="fas fa-check"></i></span> <strong>Return Rollers</strong> </li>
                <li><span class="icon"><i class="fas fa-check"></i></span> <strong>Impact Rollers</strong> </li>
                <li><span class="icon"><i class="fas fa-check"></i></span> <strong>Head Pulley</strong> </li>
    ...
    <!-- ======= Portfolio Section ======= -->
    <?php
    $directory = "assets/img/product-images/conveyor-materials/"; // Directory path
